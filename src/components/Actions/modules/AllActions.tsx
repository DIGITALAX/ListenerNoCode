          ...
          <div className="relative w-full h-fit flex flex-col gap-3">
            {allEntries?.map((entry: AllEntries, index: number) => {
              return (
                <div
                  key={index}
                  className="relative flex flex-col justify-center items-start gap-5 font-vcr text-xs px-1.5 p-2 border border-white bg-black/60"
                >
                  <div className="relative w-full h-fit justify-between items-center flex flex-row gap-2">
